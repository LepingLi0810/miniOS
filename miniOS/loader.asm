...
SetTextMode:
    ...
    jmp 8:PMEntry           ; index of the selector is 8 which is 00001000
...
[BITS 32]
PMEntry:
    mov ax, 0x10                    ; offset for segment
    mov ds, ax
    mov es, ax
    mov ss, ax
    mov esp, 0x7c00
    ...
    jmp 8:LMEntry                   ; index of the selector is 8 which is 00001000
