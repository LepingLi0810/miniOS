...
gcc -std=c99 -mcmodel=large -ffreestanding -fno-stack-protector -mno-red-zone -c vm.c
gcc -std=c99 -mcmodel=large -ffreestanding -fno-stack-protector -mno-red-zone -c proc.c
gcc -std=c99 -mcmodel=large -ffreestanding -fno-stack-protector -mno-red-zone -c syscall.c
ld -nostdlib  -T linker.lds -o kernel kernel.o main.o trapa.o trap.o lib.o print.o debug.o vm.o proc.o syscall.o
